...
#define publisher
pub_fr_hip = rospy.Publisher("/fr_hip_controller/command", Float64, queue_size= 10)
# pub_fr_knee = rospy.Publisher("/fr_knee_controller/command", Float64, queue_size= 10)

pub_br_hip = rospy.Publisher("/br_hip_controller/command", Float64, queue_size= 10)
# pub_br_knee = rospy.Publisher("/br_knee_controller/command", Float64, queue_size= 10)

pub_fl_hip = rospy.Publisher("/fl_hip_controller/command", Float64, queue_size= 10)
# pub_fl_knee = rospy.Publisher("/fl_knee_controller/command", Float64, queue_size= 10)

pub_bl_hip = rospy.Publisher("/bl_hip_controller/command", Float64, queue_size= 10)
# pub_bl_knee = rospy.Publisher("/bl_knee_controller/command", Float64, queue_size= 10)
